...
export class Sidebar {
  ...
  menuItems = signal<MenuItem[]>([
    ...
    },
    {
      ...
      badgeColor: 'primary',
      children: [
        { label: 'All Partners', icon: '', route: '/partners/list' },
        { label: 'Add Partner', icon: '', route: '/partners/add-partner' },
      ],
    },
    {
      label: 'Bonds',
      ...
      route: '/bonds',
      children: [
        { label: 'All Bonds', icon: '', route: '/bonds/list' },
        { label: 'Add Bond', icon: '', route: '/bonds/add-bond' },
      ],
    },
    {
      label: 'Bond Transactions',
      icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
      route: '/bond-transactions',
    },
    // {
    //   label: 'customers',
    //   icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
