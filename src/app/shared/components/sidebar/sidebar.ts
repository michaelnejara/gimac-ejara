...
export class Sidebar {
  ...
  menuItems = signal<MenuItem[]>([
    ...
    },
    {
      ...
      route: '/bonds',
      children: [
        { label: 'Bond Management', icon: '', route: '/bonds/list' },
        { label: 'Bond Transaction', icon: '', route: '/bonds/anomalies' },
        { label: 'Partner Management', icon: '', route: '/transactions/reconciliation' },
        { label: 'Customer Management', icon: '', route: '/transactions/reconciliation' },
